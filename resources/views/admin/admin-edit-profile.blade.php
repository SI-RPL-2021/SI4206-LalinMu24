...
<div class="container">
    <div class="card">
        <div class="card-header text-center bg-primary text-light">
            <b>Ubah Profile Admin</b> 
        </div>
        <div class="card-body" style="background-color: #E4ECEF;">
            <div class="row">
                <div class="col-sm-8">
                    <form class="ml-3" method="POST" action="/admin-update-profile/{{$admin->id}}">
                        @csrf
                        @method('patch')
                        ...
                        <div class="d-flex justify-content-center">
                            <a type="button" href="/admin-profile" class="btn btn-danger mr-3">Batal</a>
